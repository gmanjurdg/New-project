            ...
            <React.Fragment>
                <div>
                    ...
                    <Link to="/details">
                        ...
                        <img src={"http://satkarindiancuisine.com/images/menu/vag-Specialicies/Okra-Masala.png"} className="col-9 mx-auto col-md-6 col-lg-3 my-3" alt="Kofta Kurma" />
                        <img src={"https://5.imimg.com/data5/FM/UF/GLADMIN-40050325/mutter-paneer-500x500.png"} className="col-9 mx-auto col-md-6 col-lg-3 my-3" alt="Veg Momo" />
                        <img src={"http://satkarindiancuisine.com/images/menu/vag-Specialicies/Okra-Masala.png"} className="col-9 mx-auto col-md-6 col-lg-3 my-3" alt="Kadai Paneer" />
                        <img src={"https://5.imimg.com/data5/FM/UF/GLADMIN-40050325/mutter-paneer-500x500.png"} className="col-9 mx-auto col-md-6 col-lg-3 my-3" alt="Pastery" />
